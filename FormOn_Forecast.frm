...
Begin VB.Form FrmUpLoadONForeCast 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(0)=   "TxtOnhand"
      Tab(1).Control(1)=   "Txtit"
      Tab(1).Control(2)=   "TxtQty"
      Tab(1).Control(3)=   "TxtSchComment"
      Tab(1).Control(4)=   "TxtPkgGrpCd"
      Tab(1).Control(5)=   "TxtPkgCd"
      Tab(1).Control(6)=   "TxtPTI2"
      Tab(1).Control(7)=   "Txtpartid"
      Tab(1).Control(8)=   "TxtSite"
      Tab(1).Control(9)=   "Txtstage"
      Tab(1).Control(10)=   "TxtProdPartid"
      Tab(1).Control(11)=   "TxtconsItem"
      Tab(1).Control(12)=   "TxtNextSite"
      Tab(1).Control(13)=   "TxtAreacd"
      Tab(1).Control(14)=   "TxtOracleCD"
      Tab(1).Control(15)=   "Frame1"
      Tab(1).Control(16)=   "CmdClearTest"
      Tab(1).Control(17)=   "CmdSaveTest"
      Tab(1).Control(18)=   "DTPicker3"
      Tab(1).Control(19)=   "DTPicker1"
...
Set xlBook = VBExcel.Workbooks.Open(Text2.Text)
...
For I = 2 To xlSheet.Range("A1").CurrentRegion.Rows.Count
    ...
    If start_part <> out_part Then
        MsgBox "请检查start_part 和 out_part", vbCritical, "警告"
        Exit Sub
