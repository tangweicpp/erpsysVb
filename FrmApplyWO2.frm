...
Begin VB.Form FrmApplyWO2 
   Caption         =   "下工单 (分批,样品,重工)"
   ClientHeight    =   10950
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15960
   ...
   Begin VB.Frame Frame2 
      ...
      Begin FPSpreadADO.fpSpread fps 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "FrmApplyWO2.frx":0000
         TextTip         =   2
         AppearanceStyle =   0
      End
...
Public Sub AddWaferTemp(idTemp As Long, _
                        waferIdTemp As String, _
                        allQtyTemp As Integer, _
                        goodQtyTemp As Integer, _
                        lotIdTemp As String)
...
Private Sub Command1_Click()
    ...
    Else
        ...
        If (oiRS.RecordCount > 0) Then
            ...
            If Mid(UCase(Trim(TxtSourceBatchId.Text)), 1, 1) = "Q" Then
...
Private Sub Command2_Click()
    ...
    Else
        ...
        If CmbCustomer.Text = "AA" And (Right$(UCase(Trim(TxtSourceBatchId.Text)), 3) = "00A" Or Right$(UCase(Trim(TxtSourceBatchId.Text)), 3) = "00B" Or Right$(UCase(Trim(TxtSourceBatchId.Text)), 3) = "00C" Or Right$(UCase(Trim(TxtSourceBatchId.Text)), 3) = "01A" Or Right$(UCase(Trim(TxtSourceBatchId.Text)), 3) = "01B" Or Right$(UCase(Trim(TxtSourceBatchId.Text)), 3) = "01C" Or Right$(UCase(Trim(TxtSourceBatchId.Text)), 3) = "01D" Or (Left(UCase(Trim(TxtSourceBatchId.Text)), 1) = "Y" And Right$(UCase(Trim(TxtSourceBatchId.Text)), 1) = "A")) Then
...
Private Sub ComSave_Click()
    ...
    ' 20171108 tangwei 客户机种, 料号 在NPI校验
    ...
    headerTemp.ERPCreateDate = DateTime.Now
    ...
    If Mid(UCase(Trim(Text2.Text)), 2, 1) = "R" Then
        ...
        Call AddBillHeaderReWork(headerTemp)
  
    Else

        Call AddBillHeader(headerTemp)
    ...
    Call Insert_Shop_Order(headerTemp.ordername, gUserName, cuspTmp, Text3.Text, txtWODept.Text)
