...
Begin VB.Form Frm_WaiBao_Label 
   Caption         =   "晶圆委外切割标签"
   ClientHeight    =   8430
   ClientLeft      =   60
   ClientTop       =   450
   ...
   Begin VB.TextBox TxtWaferID 
      ...
      TabIndex        =   1
      Text            =   "Frm_WaiBao_Label.frx":0000
      Top             =   600
      Width           =   9255
   End
   ...
   End
End
Attribute VB_Name = "Frm_WaiBao_Label"
...
For i = 0 To UBound(bid) - 1
    ...
    cmdStr2 = " insert into tsv_qboxnumber_WaiBao select containerid,containername,qty,sysdate from container where containername= '" & lotStr & "' "
...
sqlDB = GetWaiBaoString(msgTxtTemp2)
...
TxtWaferID.Text = ""
TxtDir.Text = "\\10.160.1.14\BarCode\WAIBAOSAW\"
