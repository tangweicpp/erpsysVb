   ...
   Begin VB.Frame Frame3 
      ...
      Begin FPSpreadADO.fpSpread fps 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "FrmTSV_Bom.frx":0000
         TextTip         =   2
      End
   End
End
Attribute VB_Name = "FrmTSV_Bom"
...
cmdStr = "INSERT INTO [erpdata].[dbo].[TSVtblBillBomInitData]([PT],[WLID],[Name],[Qty],[Unit],[SHRateQty]) " & _
...
Public Sub AddRecordNew(tempPt As String, tempEMt As String, tempName As String, tempQty As String, tempUnit As String, tempRate As String, tempUserID As String)
'把添加的行，保存到DB中
Dim cmdStr As String
         
cmdStr = "INSERT INTO [erpdata].[dbo].[TSVtblBillBomInitData]([PT],[WLID],[Name],[Qty],[Unit],[SHRateQty], employ) " & _
         " VALUES('" + tempPt + "','" + tempEMt + "','" + tempName + "','" + tempQty + "','" + tempUnit + "','" + tempRate + "','" + tempUserID + "' )"
...
Set bomRS = GetFpsBomNew(ptTemp, gUserName)
If bomRS.RecordCount <= 0 Then
    MsgBox "明细表中没有相关数据，请确认"
    Exit Sub
End If
...
sqlTemp = "DELETE FROM [erpdata].[dbo].[TSVtblBillBomInitData]"
Call AddSql2(sqlTemp)

End Sub

Private Sub DelBomDataNew(useridTemp As String)
'删掉初始表数据

Dim sqlTemp As String

sqlTemp = "DELETE FROM [erpdata].[dbo].[TSVtblBillBomInitData] where employ ='" & useridTemp & "' "
Call AddSql2(sqlTemp)
...
sqlTemp = "DELETE FROM [erpdata].[dbo].[TSVtblBillBomInitData] where id=" & rowId & ""
Call AddSql2(sqlTemp)
...
sqlTemp = "DELETE FROM [erpdata].[dbo].[TSVtblBillBomInitData] where id=" & rowId & " and employ ='" & userID & "' "
Call AddSql2(sqlTemp)
...
'2015-01-03 jiayun modify

'sqlTemp = "INSERT INTO [erpdata].[dbo].[TSVtblBillBomInitData] ( [MID],[PT],[WLID],[Name],[Qty],[SHRateQty],[Unit],[PT1],[WLID1],[Name1],[Qty1],[SHRateQty1],[Unit1] ) " & _
...
'" Where a.材料规范编号 = b.材料规范编号 AND (a.物料编号='" & ptTemp & "'   OR a.是否共用标记=1) AND b.料号 NOT LIKE '18%' AND b.料号 NOT LIKE '19%' AND b.料号1 NOT LIKE '18%' AND b.料号1 NOT LIKE '19%' ORDER BY b.材料规范编号 DESC"
'
sqlTemp = "INSERT INTO [erpdata].[dbo].[TSVtblBillBomInitData] ( [MID],[PT],[WLID],[Name],[Qty],[SHRateQty],[Unit],[PT1],[WLID1],[Name1],[Qty1],[SHRateQty1],[Unit1] ) " & _
" SELECT  b.材料规范编号,b.料号,b.物料编号,b.名称,cast(b.每只用量 as varchar),b.损耗,b.单位,b.料号1,b.物料编号1,b.名称1,cast(b.备料用量 as varchar),b.损耗1,b.单位1 " & _
" FROM [erpdata].[dbo].[TSVtblSetMRule] a,[erpdata].[dbo].[TSVtblMRuleData] b " & _
...
'" Where a.材料规范编号 = b.材料规范编号 AND (a.物料编号='" & ptTemp & "'   OR a.是否共用标记=1) AND b.料号 NOT LIKE '18%' AND b.料号 NOT LIKE '19%' AND b.料号1 NOT LIKE '18%' AND b.料号1 NOT LIKE '19%' ORDER BY b.材料规范编号 DESC"
'
sqlTemp = "INSERT INTO [erpdata].[dbo].[TSVtblBillBomInitData] ( [MID],[PT],[WLID],[Name],[Qty],[SHRateQty],[Unit],[PT1],[WLID1],[Name1],[Qty1],[SHRateQty1],[Unit1], employ) " & _
