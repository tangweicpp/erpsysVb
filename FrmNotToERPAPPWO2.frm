...
Begin VB.Form FrmNotToERPApplyWO2 
   Caption         =   "不进财务系统的分批、样品、重工"
   ClientHeight    =   10950
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   18765
   ...
   Begin VB.Frame Frame2 
      ...
      Begin FPSpreadADO.fpSpread fps 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "FrmNotToERPAPPWO2.frx":0000
         TextTip         =   2
         AppearanceStyle =   0
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox applyUserTxt 
         ...
         Width           =   2295
      End
      Begin VB.CheckBox CekWLD 
         Caption         =   "GC WLD/T二次工单"
         ForeColor       =   &H000000FF&
         Height          =   615
         Left            =   12840
         TabIndex        =   78
   ...
   End
End
Attribute VB_Name = "FrmNotToERPApplyWO2"
...
'         If TxtSourceBatchId.Text = "7625799013" Then
'
...
If CekWLD.Value = 1 Then
Set listRS = GetFps2GCWld(strwhereTemp, customerTemp)
Else
...
'2015-07-05 jiayun add  不进财务系统的工单进虚拟仓库
...
If Mid(UCase(Trim(Text2.Text)), 2, 1) = "R" Then
  ...
  Call AddBillHeaderReWorkNotToERP(headerTemp)
  
  
Else

  Call AddBillHeaderNotToErp(headerTemp)
