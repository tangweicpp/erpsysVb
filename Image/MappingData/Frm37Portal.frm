...
Begin VB.Form Frm37Portal 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(0)=   "ChkAll"
      Tab(0).Control(1)=   "CmdWaferRecOut"
      Tab(0).Control(2)=   "CmdWaferRecQuery"
      ...
      Tab(1).Control(1)=   "CmdPOComitOut"
      Tab(1).Control(2)=   "CmdPOComit"
      ...
      Tab(3).Control(0)=   "CmbPoType"
      Tab(3).Control(1)=   "Txt37BillNo"
      Tab(3).Control(2)=   "CmdPOComplete"
      Tab(3).Control(3)=   "CmdPOCompleteOut"
      Tab(3).Control(4)=   "fps(3)"
      ...
      Tab(4).Control(2)=   "fps(4)"
      Tab(4).Control(3)=   "Txt37BillNoShip"
      Tab(4).Control(4)=   "CmdPOShip"
      Tab(4).Control(5)=   "CmdPOShipOut"
      Tab(4).Control(6)=   "ComboShipICI"
      Tab(4).ControlCount=   7
      TabCaption(5)   =   "PO Recommit"
      TabPicture(5)   =   "Frm37Portal.frx":009F
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "fps(5)"
      ...
      Begin FPSpreadADO.fpSpread fps 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "Frm37Portal.frx":0567
         TextTip         =   2
         AppearanceStyle =   0
      End
      Begin FPSpreadADO.fpSpread fps 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "Frm37Portal.frx":09D7
         TextTip         =   2
         AppearanceStyle =   0
      End
      Begin FPSpreadADO.fpSpread fps 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "Frm37Portal.frx":0E47
         TextTip         =   2
         AppearanceStyle =   0
      End
      Begin FPSpreadADO.fpSpread fps 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "Frm37Portal.frx":12B7
         TextTip         =   2
         AppearanceStyle =   0
      End
      Begin FPSpreadADO.fpSpread fps 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "Frm37Portal.frx":1727
         TextTip         =   2
         AppearanceStyle =   0
      End
        ...
        If Trim(strColTmp(18)) <> "Y" Then
            ...
            For j = 0 To UBound(strRowTmp)
                ...
                If Trim$(strColTmp1(18)) = "Y" Then
                    ...
                    If strPo = Trim(strColTmp1(26)) And strLOT = Trim(strColTmp1(27)) And strQty = Trim$(strColTmp1(28)) Then
                        b_flag = True
                        Exit For
                    End If
                End If
