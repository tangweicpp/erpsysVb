...
Begin VB.Form Frm_45_Label 
   Caption         =   "裂片45客户WaferID标签"
   ClientHeight    =   8430
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   14055
   ...
   End
End
Attribute VB_Name = "Frm_45_Label"
...
For i = 0 To UBound(bid) - 1
    ...
    cmdStr2 = "insert into tsv_qboxnumber_LiePian45(waferscribenumber,create_by,create_date) values ('" & lotStr & "' ,'" & userNameTemp & "' ,sysdate)  "
...
sqlDB = GetLiePian45String(msgTxtTemp2)
...
TxtWaferID.Text = ""
TxtDir.Text = "\\10.160.1.14\BarCode\艾特曼裂片\"
