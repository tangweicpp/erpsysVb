...
Begin VB.Form FrmOnHTPTCross 
   Caption         =   "Huatian Part Cross Reference"
   ClientHeight    =   10155
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   19080
   ...
   Begin FPSpreadADO.fpSpread fps 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "FrmOnHTPTCross.frx":0000
      TextTip         =   2
   End
End
Attribute VB_Name = "FrmOnHTPTCross"
...
Dim temp As String
  ...
  temp = " select id, NewOnOPNPart,FG_Legacy ,OPN_Site ,WDQ ,WDQ_Legacy,WDQ_Site,NewOnWSGPart ,WSG_Legacy ,WSG_Site ," & _
...
Private Sub IniFpsHeader()
    With fps(0)
        ...
        .SetText E_FPS0.E_NewOnOPNPart, 0, "NewOnOPNPart"
        .SetText E_FPS0.E_FG_Legacy, 0, "FG_Legacy"
        .SetText E_FPS0.E_OPN_Site, 0, "OPN_Site"
        
        
        .SetText E_FPS0.E_WDQ, 0, "WDQ"
        .SetText E_FPS0.E_WDQ_Legacy, 0, "WDQ_Legacy"
        .SetText E_FPS0.E_WDQ_Site, 0, "WDQ_Site"
        
        .SetText E_FPS0.E_NewOnWSGPart, 0, "NewOnWSGPart"
        .SetText E_FPS0.E_WSG_Legacy, 0, "WSG_Legacy"
        .SetText E_FPS0.E_WSG_Site, 0, "WSG_Site"
        
        
        .SetText E_FPS0.E_GRV, 0, "GRV"
        .SetText E_FPS0.E_GRV_Legacy, 0, "GRV_Legacy"
        .SetText E_FPS0.E_GRV_Site, 0, "GRV_Site"
        
        .SetText E_FPS0.E_SWF, 0, "SWF"
        .SetText E_FPS0.E_SWF_Legacy, 0, "SWF_Legacy"
        .SetText E_FPS0.E_SWF_Site, 0, "SWF_Site"
        ...
        .ColWidth(E_FPS0.E_SeqId) = 4
        .ColWidth(E_FPS0.E_NewOnOPNPart) = 16
        .ColWidth(E_FPS0.E_FG_Legacy) = 6
        .ColWidth(E_FPS0.E_OPN_Site) = 16
        
        .ColWidth(E_FPS0.E_WDQ) = 16
        .ColWidth(E_FPS0.E_WDQ_Legacy) = 6
        .ColWidth(E_FPS0.E_WDQ_Site) = 16
        
        .ColWidth(E_FPS0.E_NewOnWSGPart) = 16
        .ColWidth(E_FPS0.E_WSG_Legacy) = 6
        .ColWidth(E_FPS0.E_WSG_Site) = 16
        
        .ColWidth(E_FPS0.E_GRV) = 16
         .ColWidth(E_FPS0.E_GRV_Legacy) = 6
        .ColWidth(E_FPS0.E_GRV_Site) = 16
        
         .ColWidth(E_FPS0.E_SWF) = 16
         .ColWidth(E_FPS0.E_SWF_Legacy) = 6
        .ColWidth(E_FPS0.E_SWF_Site) = 16
