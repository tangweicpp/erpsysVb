...
sqlTemp = " insert into tblTestNo2(productname,testedition,FIELDNAME1,FIELDVALUE1,Remark1,FIELDNAME2,FIELDVALUE2,Remark2,FIELDNAME3,FIELDVALUE3,Remark3,createdby,createddate,flag,productnamenew ) " & _
          " values  ('" & tempProduct & "','" & tempTestNo & "','" & tempKey1 & "','" & tempValue1 & "','" & otherValue1 & "','" & tempKey2 & "','" & tempValue2 & "','" & otherValue2 & "','" & tempKey3 & "','" & tempValue3 & "','" & otherValue3 & "','Auto',sysdate,'Y','" & tempProductNew & "')"
AddSql (sqlTemp)
