...
Begin VB.Form FrmOnMPN 
   ...
   Begin FPSpreadADO.fpSpread fps 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "FrmOnMPN.frx":0000
      TextTip         =   2
   End
End
...
Dim temp As String
  ...
  temp = " select id, LOC,PART,MarkingCodeFirst,LEAD_FREE,ECAT,MSL,TEMP,HALIDE_FREE,PBF_DIE_ATTACH,MPQ_QTY,PACKAGING_TYPE,PKG_GRP_CD,UL_LISTED_FLAG  from  CUSTOMERMPNAttributes where flag='Y' order by id "
...
Private Sub IniFpsHeader()
    With fps(0)
        ...
        .SetText E_FPS0.E_Loc, 0, "Loc"
        .SetText E_FPS0.E_PART, 0, "PART"
        .SetText E_FPS0.E_MarkingCode, 0, "FrontSideMarking"

        .SetText E_FPS0.E_LEAD_FREE, 0, "LEAD_FREE"
        .SetText E_FPS0.E_ECAT, 0, "ECAT"
        .SetText E_FPS0.E_MSL, 0, "MSL"
        
        .SetText E_FPS0.E_Temp, 0, "Temp"
        .SetText E_FPS0.E_HALIDE_FREE, 0, "HALIDE_FREE"
        .SetText E_FPS0.E_PBF_DIE_ATTACH, 0, "PBF_DIE_ATTACH"
        .SetText E_FPS0.E_MPQ_QTY, 0, "MPQ_QTY"
        .SetText E_FPS0.E_PACKAGING_TYPE, 0, "PACKAGING_TYPE"
        
        .SetText E_FPS0.E_PKG_GRP_CD, 0, "PKG_GRP_CD"
        .SetText E_FPS0.E_UL_LISTED_FLAG, 0, "UL_LISTED_FLAG"
  
        
    
        .ColWidth(E_FPS0.E_SeqId) = 6
        .ColWidth(E_FPS0.E_Loc) = 6
        .ColWidth(E_FPS0.E_PART) = 20
        .ColWidth(E_FPS0.E_MarkingCode) = 15
        .ColWidth(E_FPS0.E_LEAD_FREE) = 9
        .ColWidth(E_FPS0.E_ECAT) = 6
        .ColWidth(E_FPS0.E_MSL) = 6
        
        .ColWidth(E_FPS0.E_Temp) = 6
        .ColWidth(E_FPS0.E_HALIDE_FREE) = 10
        .ColWidth(E_FPS0.E_PBF_DIE_ATTACH) = 13
        .ColWidth(E_FPS0.E_MPQ_QTY) = 10
        .ColWidth(E_FPS0.E_PACKAGING_TYPE) = 15
        
        
         .ColWidth(E_FPS0.E_PKG_GRP_CD) = 10
        .ColWidth(E_FPS0.E_UL_LISTED_FLAG) = 10
