...
Begin VB.Form FrmDummy 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo2 
         Height          =   315
         ItemData        =   "FrmDummy.frx":049A
         Left            =   3960
         List            =   "FrmDummy.frx":049C
...
Private Sub IniProduct()
    ...
    Set mainItemRS = GetDummyProduct(cus)
