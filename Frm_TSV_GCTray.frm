...
Begin VB.Form Frm_TSV_GCTray 
   ...
   Begin FPSpreadADO.fpSpread fps 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "Frm_TSV_GCTray.frx":0000
      TextTip         =   2
   End
End
Attribute VB_Name = "Frm_TSV_GCTray"
...
Private Enum E_FPS0          'Detail
    ...
    E_WaferNormalQty    'TotalWafer(Normal)
    E_WaferWLAQty       'TotalWafer(WLA)
    
    E_TrayNormalGoodQty   'TotalTrayGood(Normal)
    E_TrayNormalNGQty   'TotalTrayNG(Normal)
    E_TrayWLAGoodQty   'TotalTrayGood(WLA)
    E_TrayWLANGQty      'TotalTrayNG(WLA)
    
    E_InvQtyGoodQty    'Good Tray(本周库存量)
    E_InvQtyNGQty      'NG Tray(本周库存量)
    
    E_DiffQtyGoodQty    '良品差异量
    E_DiffQtyNGQty      '不良品差异量
...
'                InvNGQty = 0
                ...
                waferNormalQty = GetQtyTotalWaferV2(cusPTTemp, endDate)
...
'                   TrayNGWlaQty = rate_WlaNG * waferWlaQty
                   ...
                   normalSetQty = GetQtySETNormalWaferV2(cusPTTemp, endDate)
...
.SetText E_FPS0.E_WaferNormalQty, 0, "TotalWafer(Normal)"
.SetText E_FPS0.E_WaferWLAQty, 0, "TotalWafer(WLA)"


.SetText E_FPS0.E_TrayNormalGoodQty, 0, "TotalTrayGood(Normal)"
.SetText E_FPS0.E_TrayNormalNGQty, 0, "TotalTrayNG(Normal)"
.SetText E_FPS0.E_TrayWLAGoodQty, 0, "TotalTrayGood(WLA)"
.SetText E_FPS0.E_TrayWLANGQty, 0, "TotalTrayNG(WLA)"

.SetText E_FPS0.E_InvQtyGoodQty, 0, "Good Tray(本周库存量)"
.SetText E_FPS0.E_InvQtyNGQty, 0, "NG Tray(本周库存量)"

.SetText E_FPS0.E_DiffQtyGoodQty, 0, "良品差异量"
.SetText E_FPS0.E_DiffQtyNGQty, 0, "不良品差异量"
    


        .ColWidth(E_FPS0.E_ID) = 5
        .ColWidth(E_FPS0.E_Factory) = 8
        .ColWidth(E_FPS0.E_CustomerPT) = 8
        .ColWidth(E_FPS0.E_HTPT) = 8
        
        .ColWidth(E_FPS0.E_RateNormalGood) = 8
        .ColWidth(E_FPS0.E_RateNormalNG) = 8
        .ColWidth(E_FPS0.E_RateWLAGood) = 8
        .ColWidth(E_FPS0.E_RateWLANG) = 8
        
        .ColWidth(E_FPS0.E_WaferNormalQty) = 8
        .ColWidth(E_FPS0.E_WaferWLAQty) = 8
        
        .ColWidth(E_FPS0.E_TrayNormalGoodQty) = 8
        .ColWidth(E_FPS0.E_TrayNormalNGQty) = 8
        .ColWidth(E_FPS0.E_TrayWLAGoodQty) = 8
        .ColWidth(E_FPS0.E_TrayWLANGQty) = 8
        
        
        .ColWidth(E_FPS0.E_InvQtyGoodQty) = 8
        .ColWidth(E_FPS0.E_InvQtyNGQty) = 8
        
        
        .ColWidth(E_FPS0.E_DiffQtyGoodQty) = 8
        .ColWidth(E_FPS0.E_DiffQtyNGQty) = 8
